...
LastEditTime: 2022-04-01 09:06:34
'''

import tensorflow as tf
from Layers.CrossNetV2 import CrossNetV2
...
class DeepCrossV2(tf.keras.Model):
    def __init__(self, options, name="DeepCrossV2"):
        super(DeepCrossV2, self).__init__(name=name)
    ...
    def build(self, input_shape):
        ...
        self.cross_section = CrossNetV2(self.num_cross, self.field_dim*self.embedding_dim)
        self.embedding_section = EmbeddingLayer(self.field_dim, self.field_sub_dim)
