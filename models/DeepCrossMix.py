...
from Layers.CrossNetMix import CrossNetMix
...
class DeepCrossMix(tf.keras.Model):
    def __init__(self, options, name="DeepCrossMix"):
        super(DeepCrossMix, self).__init__(name=name)
    ...
    def build(self, input_shape):
        ...
        self.cross_section = CrossNetMix(self.num_cross, self.field_dim*self.embedding_dim)
        self.embedding_section = EmbeddingLayer(self.field_dim, self.field_sub_dim)
